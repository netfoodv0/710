// Componentes principais de relatórios
...
// Componentes de distribuição e categorias
export { DistribuicaoClientesCategoria } from './DistribuicaoClientesCategoria';
export { DistribuicaoCategoria } from './DistribuicaoCategoria';

// Calculadoras e configurações
export { CalculadoraClientes } from './CalculadoraClientes';
