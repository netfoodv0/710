...
export const PedidosSessaoSkeleton = () => (
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 px-6">
    {/* Card Em Análise */}
    <div className="bg-white border h-[62px] rounded-t-lg mb-3 transition-all duration-300 ease-in-out" style={{ borderColor: 'rgb(207, 209, 211)' }}>
...
export const PedidosListaSkeleton = () => (
  <div className="space-y-3">
    {[1, 2, 3, 4, 5].map((i) => (
      <div key={i} className="bg-white border rounded-lg p-4 transition-all duration-300 ease-in-out" style={{ borderColor: 'rgb(207, 209, 211)' }}>
...
export const PedidosPageSkeleton = () => (
  <div className="min-h-screen bg-gray-50">
    {/* Header */}
    <div className="bg-white border-b px-6 py-4 transition-all duration-300 ease-in-out" style={{ borderColor: 'rgb(207, 209, 211)' }}>
