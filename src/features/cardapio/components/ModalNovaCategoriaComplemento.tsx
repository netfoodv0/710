...
interface ModalNovaCategoriaComplementoProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm?: (categoriaId: string) => void;
}

export function ModalNovaCategoriaComplemento({ isOpen, onClose, onConfirm }: ModalNovaCategoriaComplementoProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const categoriaId = await ComplementosService.criarCategoriaComplemento(user.uid, nome.trim());
  ...
  return (
    <ModalGlobal
      isOpen={isOpen}
      onClose={handleClose}
      title="Nova Categoria de Complemento"
      size="sm"
      footer={footer}
    >
