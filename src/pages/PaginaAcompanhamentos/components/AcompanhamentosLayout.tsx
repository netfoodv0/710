...
import { AcompanhamentosStats } from './AcompanhamentosStats';
import { AcompanhamentosTable } from './AcompanhamentosTable';
import { AcompanhamentosLayoutProps } from '../types';

export function AcompanhamentosLayout({
  produtos,
  columns,
  loading,
  error,
    ...
    <ErrorBoundary>
      <div className="min-h-screen w-full overflow-x-hidden">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 pt-2 pb-12">
          ...
          {loading && (
            <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-center gap-2 text-blue-700">
                ...
                <span className="text-sm">Carregando dados dos acompanhamentos...</span>
              </div>
            </div>
          )}
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">Erro ao carregar acompanhamentos</h3>
          ...
          {/* Estatísticas */}
          <AcompanhamentosStats produtos={produtos} />
