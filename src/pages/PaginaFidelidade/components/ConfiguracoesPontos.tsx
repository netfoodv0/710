...
import { BagIcon, UsersIcon, RevenueIcon } from '../../../components/ui';

interface ConfiguracoesPontosProps {
...
}: ConfiguracoesPontosProps) {
  // Assumindo que o sistema está ativo por padrão
  const sistemaPontosAtivo = true;
            ...
            <div className="flex-1">
              <div>
                ...
                <input
                  ...
                  max="100"
                  value={pontosPorReal}
                  onChange={(e) => onPontosPorRealChange(Number(e.target.value))}
            ...
            <div className="flex-1">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => onPontosBoasVindasChange(Number(e.target.value))}
                  disabled={!sistemaPontosAtivo}
                  className={`w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent ${
                    sistemaPontosAtivo 
                      ? 'border-gray-300 text-purple-600' 
