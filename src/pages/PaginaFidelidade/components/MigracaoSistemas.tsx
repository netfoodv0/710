...
interface MigracaoSistemasProps {
  onMigracao: (tipo: 'cashback-para-pontos' | 'pontos-para-cashback') => void;
}

export function MigracaoSistemas({ onMigracao }: MigracaoSistemasProps) {
  return (
    <div className="bg-white border rounded-lg" style={{ borderColor: '#cfd1d3', padding: '24px' }}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="border border-gray-200 rounded-lg p-4">
          ...
          <button 
            onClick={() => onMigracao('cashback-para-pontos')}
        ...
        <div className="border border-gray-200 rounded-lg p-4">
          ...
          <button 
            onClick={() => onMigracao('pontos-para-cashback')}
            className="px-4 py-2 border border-purple-500 text-purple-500 rounded hover:bg-purple-50 hover:border-purple-600 transition-colors"
          >
            Iniciar Migração
          </button>
